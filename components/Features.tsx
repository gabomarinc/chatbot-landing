          ...
          <div className="lg:col-span-6 flex flex-col justify-center relative z-20">
            ...
            <div className="space-y-4 mb-10 max-w-lg">
              {featuresData.map((feature, index) => (
                <div
                  ...
                  className={`group cursor-pointer p-4 rounded-2xl transition-all duration-300 border ${activeIndex === index
            ...
            <div>
              <Button
                ...
                href="https://calendly.com/wearekonsul/konsul-ecosistema-ia"
              >
            ...
            <div className="absolute bottom-0 left-0 right-0 flex justify-center gap-3 lg:hidden">
              {featuresData.map((_, i) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all duration-300 ${activeIndex === i ? 'w-8 bg-[#27bea5]' : 'w-2 bg-gray-700'
                    }`}
                />
              ))}
            </div>
