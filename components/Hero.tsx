                                ...
                                {['Agente', 'Admin', 'Propietario'].map((role) => (
                                    <button 
                                        ...
                                        className={`flex-1 py-2 text-xs font-medium rounded-lg transition-all ${
                                            (selectedMember.role === role) || (selectedMember.roleType === 'owner' && role === 'Propietario')
                          ...
                          <AnimatePresence mode="popLayout">
                            {messages.map((msg) => (
                              ...
                              >
                                ...
                                <div 
                                  className={`p-3 md:p-4 rounded-2xl text-xs md:text-sm max-w-[85%] md:max-w-[80%] leading-relaxed shadow-lg font-normal ${
                                    msg.role === 'user' 
                          ...
                          <AnimatePresence>
                            {isTyping && (
                              ...
                              >
                                ...
                                <div className={`p-4 rounded-2xl flex items-center gap-1 h-[48px] md:h-[52px] ${
                                   isTyping === 'user' 
